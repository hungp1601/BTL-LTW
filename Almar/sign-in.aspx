<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sign-in.aspx.cs" Inherits="Almar.sign_in" %>
...
<body>
    ...
    <div class="body-about">
        <div class="body-about-0">
            <div id="sign-in">
                <form method="POST" action="signin.aspx" id="login">
                    <div class="box">
                        <h1>Sign In</h1>
                        ...
                        <input type="password" name="password" id="password" class="password" placeholder="Password"
                               value="" />
                        <div class="sign">
                            <div type="submit" onclick="check()" class="no-under btn" style="border: 2px solid black;">
                                Sign
                                In
                            </div>
                            <a href="sign-up.aspx" type="submit" onclick="swap1()"  class="no-under" id="btn2">Sign Up</a>
                        </div>
